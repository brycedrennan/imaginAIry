...
N ?= 3
EXTRA ?= 2
vast-cluster:  ## Rent N+EXTRA instances, benchmark, keep best N
	uv run -- python -u -c "from tests.vast.vast_cluster import get_ready_cluster; get_ready_cluster(n=$(N), extra=$(EXTRA))"
