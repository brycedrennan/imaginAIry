...
# from ldm.log_utils import configure_logging
# from ldm.util import TimedLogger, instantiate_from_config
...
def main():
    ...
    try:
        ...
        if not opt.finetune_from == "":
            logger.info(f"Attempting to load state from {opt.finetune_from}")
